...
const AssetDetail = () => {
  ...
  const fetchAsset = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`${process.env.REACT_APP_API_URL}/assets/${id}`);
  ...
  const handleCheckout = async (data) => {
    try {
      await axios.post(`${process.env.REACT_APP_API_URL}/assets/${id}/checkout`, data);
  ...
  const handleReturn = async () => {
    try {
      await axios.post(`${process.env.REACT_APP_API_URL}/assets/${id}/return`, {
