...
const LibraryPage = () => {
  ...
  const fetchBooks = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`${process.env.REACT_APP_API_URL}/library/books`);
  ...
  const fetchMyBooks = async () => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_API_URL}/library/my-books`);
  ...
  const fetchStats = async () => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_API_URL}/library/stats`);
  ...
  const handleCheckout = async (book) => {
    try {
      await axios.post(`${process.env.REACT_APP_API_URL}/library/checkout`, {
        bookId: book._id,
  ...
  const handleCreateBook = async (bookData) => {
    try {
      await axios.post(`${process.env.REACT_APP_API_URL}/library/books`, bookData);
